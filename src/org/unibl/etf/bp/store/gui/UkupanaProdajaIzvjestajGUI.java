...
public class UkupanaProdajaIzvjestajGUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UkupanaProdajaIzvjestajGUI frame = new UkupanaProdajaIzvjestajGUI();
	 ...
	 * Create the frame.
	 */
	public UkupanaProdajaIzvjestajGUI() {
		podaci = Utilities.getDataAccessFactory().getIzvjestajiDataAccess().ukupanProdaja();
		kolone = new Vector<Object>();
		kolone.add("Mjesto");
		kolone.add("Adresa");
		kolone.add("Telefon");
		kolone.add("Ukupna prodaja");
