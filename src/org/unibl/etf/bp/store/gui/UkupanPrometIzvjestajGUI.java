...
public class UkupanPrometIzvjestajGUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UkupanPrometIzvjestajGUI frame = new UkupanPrometIzvjestajGUI();
	 ...
	 * Create the frame.
	 */
	public UkupanPrometIzvjestajGUI() {
		podaci = Utilities.getDataAccessFactory().getIzvjestajiDataAccess().ukupanPromet();
		kolone = new Vector<Object>();
		kolone.add("Mjesto");
		kolone.add("Adresa");
		kolone.add("Telefon");
		kolone.add("Ukupan promet");
